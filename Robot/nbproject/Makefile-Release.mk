...
${OBJECTDIR}/src/components/AX12.o: src/components/AX12.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/components/AX12.o src/components/AX12.cpp

${OBJECTDIR}/src/components/LCD.o: src/components/LCD.cpp
	${MKDIR} -p ${OBJECTDIR}/src/components
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/components/LCD.o src/components/LCD.cpp

${OBJECTDIR}/src/components/US_sensor.o: src/components/US_sensor.cpp
	${MKDIR} -p ${OBJECTDIR}/src/components
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/components/US_sensor.o src/components/US_sensor.cpp

${OBJECTDIR}/src/components/kangaroo.o: src/components/kangaroo.cpp
	${MKDIR} -p ${OBJECTDIR}/src/components
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/components/kangaroo.o src/components/kangaroo.cpp

${OBJECTDIR}/src/components/serialport.o: src/components/serialport.cpp
	${MKDIR} -p ${OBJECTDIR}/src/components
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/components/serialport.o src/components/serialport.cpp

${OBJECTDIR}/src/robot/Robot.o: src/robot/Robot.cpp
	${MKDIR} -p ${OBJECTDIR}/src/robot
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/robot/Robot.o src/robot/Robot.cpp
